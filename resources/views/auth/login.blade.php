...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="relative z-10 max-w-md w-full bg-white shadow-lg rounded-lg p-8">
        ...
        <form action="{{ route('login.submit') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="username" id="username" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all" required>
                </div>
            </div>
            <div class="mb-4">
